    ...
    <View style={styles.screen}>
      ...
      >
        ...
        <Text style={styles.subtitle}>
          Saving updates the live activity and notifies members with a pending
          or approved place.
        </Text>
        <Field label="Title">
          <TextInput
        ...
        {isCircle ? (
          <Stepper
            ...
            onDecrease={() =>
              setDurationWeeks((value) => Math.max(2, value - 1))
            }
            onIncrease={() =>
        ...
        <Stepper
          ...
          onIncrease={() =>
            setCapacity((value) => Math.min(isCircle ? 16 : 20, value + 1))
          }
        />
        <Field label="Activity style">
          <View style={styles.choiceList}>
            {difficulties.map((option) => (
              <Pressable
                ...
                style={[
                  styles.choice,
                  difficulty === option && styles.choiceSelected,
                ]}
              >
                <Text
                  style={[
                    styles.choiceText,
                    difficulty === option && styles.choiceTextSelected,
                  ]}
                >
        ...
        <Pressable
          ...
          onPress={() => void save()}
          style={[styles.saveButton, (saving || cancelling) && styles.disabled]}
        >
        ...
        <View style={styles.cancelSection}>
          <Text style={styles.cancelTitle}>
            Cancel {isCircle ? 'this circle' : 'this event'}
          </Text>
          <Text style={styles.cancelCopy}>
            This cannot be undone. Members with requests or confirmed places
            will be notified.
          </Text>
          <TextInput
            multiline
          ...
          <Pressable
            ...
            style={[
              styles.cancelButton,
              (saving || cancelling) && styles.disabled,
            ]}
          >
...
function difficultyValue(
  value: DiscoveryItem['difficulty'],
): ActivityEditInput['difficulty'] {
